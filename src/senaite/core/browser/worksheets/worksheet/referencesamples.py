...
class ReferenceSamplesView(ListingView):
    ...
    def __init__(self, context, request):
        ...
        self.title = translate(_(
            u"listing_reference_samples_title",
        ...
        self.columns = collections.OrderedDict((
            ("Title", {
                "title": _(
                    u"listing_reference_samples_column_title",
                    default=u"Reference Sample"
                ),
                "sortable": False,
            }),
            ("SupportedServices", {
                "title": _(
                    u"listing_reference_samples_column_supported_services",
                    default=u"Supported Services"
                ),
                "type": "multichoice",
                "sortable": False,
            }),
        ...
        self.review_states = [
            {
                "id": "default",
                "title": _(
                    u"listing_reference_samples_state_all",
                    default=u"All"
                ),
                "contentFilter": {},
                "transitions": [{"id": "add"}],
